...
namespace LegalApp.API.Migrations
{
    ...
    [Migration("20250807190841_EnhanceDocumentManagementSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentAccessControl", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DocumentAccessControl");
                });

            modelBuilder.Entity("LegalApp.API.Models.DocumentCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentTagAssignment", b =>
                {
                    b.Property<Guid>("DocumentId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("document_tag_assignments", (string)null);
                });

            modelBuilder.Entity("LegalApp.API.Models.DocumentUserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DocumentAccessControlId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DocumentAccessControlId");
                    ...
                    b.ToTable("document_user_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("LegalApp.API.Models.ClientDocument", b =>
                {
                    b.HasOne("LegalApp.API.Models.User", "ArchivedByUser")
                        .WithMany()
                        .HasForeignKey("ArchivedByUserId");

                    b.HasOne("LegalApp.API.Models.DocumentCategory", "Category")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentAccessControl", b =>
                {
                    ...
                    b.HasOne("LegalApp.API.Models.ClientDocument", "Document")
                        .WithOne("AccessControl")
                        .HasForeignKey("LegalApp.API.Models.DocumentAccessControl", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentCategory", b =>
                {
                    b.HasOne("LegalApp.API.Models.DocumentCategory", "ParentCategory")
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentTagAssignment", b =>
                {
                    b.HasOne("LegalApp.API.Models.User", "AssignedByUser")
                        .WithMany()
                    ...
                    b.HasOne("LegalApp.API.Models.DocumentTag", "Tag")
                        .WithMany("DocumentTagAssignments")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentUserPermission", b =>
                {
                    b.HasOne("LegalApp.API.Models.DocumentAccessControl", null)
                        .WithMany("UserPermissions")
                        .HasForeignKey("DocumentAccessControlId");
                    ...
                    b.HasOne("LegalApp.API.Models.User", "GrantedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LegalApp.API.Models.DocumentTag", b =>
                {
                    b.Navigation("DocumentTagAssignments");
                });
